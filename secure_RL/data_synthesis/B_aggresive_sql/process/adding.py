...
with open("C:\\Users\\Lenovo\\torch\\research\\NL2SQL\\secure_RL\\data_synthesis\\A_safe_condition\\omni_whole_column_filtered.json", 'r', encoding="utf-8") as f:
    safe_conditions = json.load(f)
with open("C:\\Users\\Lenovo\\torch\\research\\NL2SQL\\secure_RL\\data_synthesis\\B_aggresive_sql\\output\infer.json", 'r', encoding="utf-8") as f:
    output = json.load(f)
