...
def inject(item, template):
    ...
    with open(r"C:\Users\Lenovo\torch\research\NL2SQL\secure_RL\data_synthesis\original_data\omni_2000.json", "r",encoding='utf-8') as f:
        db = json.load(f)

    # Generate trigger text
    if tidx == 2:
        tables = parse_schema(db[item["id"]])
...
if __name__ == '__main__':
    path = r'C:\Users\Lenovo\torch\research\NL2SQL\secure_RL\data_synthesis\E_secure_COT\safe_cot\Syn_Ultimate_clean.json'
