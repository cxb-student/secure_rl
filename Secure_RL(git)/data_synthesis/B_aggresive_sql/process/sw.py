...
def main():
    # 设置输入和输出文件路径
    input_path = r"C:\Users\Lenovo\torch\research\NL2SQL\secure_RL\data_synthesis\B_aggresive_sql\EX_output\U_cells_direct.json"
    output_path = r"C:\Users\Lenovo\torch\research\NL2SQL\secure_RL\data_synthesis\B_aggresive_sql\EX_output\U_cells_direct.json"
    ...
    data = remove_duplicate_sql(data)
    ...
    print(
        f"去重前数据项: {original_count}，去重后数据项: {deduped_count}，去除了 {original_count - deduped_count} 个重复项")
