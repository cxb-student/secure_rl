...
# 读取原始JSON文件
with open(
        'C:\\Users\\Lenovo\\torch\\research\\NL2SQL\\secure_RL\\data_synthesis\\A_safe_condition\\omni\\output_cells.json',
...
# 保存为新的JSON文件
with open(
        'C:\\Users\\Lenovo\\torch\\research\\NL2SQL\\secure_RL\\data_synthesis\\A_safe_condition\\omni_cells.json',
